<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New_mt.aspx.cs" Inherits="COMMCHINA.chanpi.New_mt" %>
    ...
    <%--<div class="ui-path">
            ...
            <li>
              <div class="i on"><a href="callcenter.html">新闻中心</a>
                <p>
                  ...
                  <a href="New_mt.aspx" class="on">媒体报道</a>
      ...
      <div class="menui">
          <div class="menu">
              <ul class="menu-new">
                  ...
                  <li><a href="New_mt.aspx#about-con" class="on">媒体报道</a></li>
      ...
      <%=newsStr.ToString() %>
          <%--<div class="container container_shadow">
                <div class="page_fl" style="background: url(img/News_tap/tab2_1.jpg) no-repeat center center;"></div>
                <div class="page_fr">
                    <h2 class="red">云讯科技：积极布局流量业务 拥抱大连接时代</h2>
                    <p>由美国学者尼古拉斯·克里斯塔基斯（Nicholas A. Christakis）和詹姆斯·富勒（Ja<br>mes H. Fowler）首先提出并描绘的“大连接”时代，正在向我们招手。</p>
                    <span>2016-12-26</span>
                    <a href="New_mt_page1.html">阅读全文</a>
                </div>
            </div>
          <div class="ht40"></div>
          <div class="container container_shadow">
          ...
          <div class="page">
              <ul>
                  ...
                  <li class="on"><a href="New_dt.aspx">1</a></li>
                  <li><a href="New_dt2.html">2</a></li>
