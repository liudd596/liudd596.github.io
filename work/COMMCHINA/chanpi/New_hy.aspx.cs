...
{
    public partial class New_hy : System.Web.UI.Page
    {
        int Pageindex = 1;
        int pageSize = 4;
        ...
        private void createTable()
        {
            ...
            DataTable dt = bll.GetListByPage(" cid=5", "", (Pageindex - 1) * pageSize + 1, Pageindex * pageSize).Tables[0];
            List<YTX.Model.iNethinkCMS_Content> list = new List<YTX.Model.iNethinkCMS_Content>();
            if (dt != null && dt.Rows.Count > 0)
            {
                list = bll.DataTableToList(dt);
            }
            int totalCount = bll.GetRecordCount(" cid=5");
            ...
            if (Pageindex == 1)
            {
                ...
                newsStr.Append("<li class=\"on\"><a href=\"New_hy.aspx?pageindex=").Append(Pageindex).Append("\" >").Append(Pageindex).Append("</a></li>");
                for (int i = 1; i <= 2; i++)
                {
                    if (Pageindex + i <= pageCount)
                    {
                        newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=").Append(Pageindex + i).Append("\" >").Append(Pageindex + i).Append("</a></li>");
                    }
                }
                if (pageCount >= 2)
                {
                    newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=" + (Pageindex + 1) + "\"><img src=\"img/News_tap/page_next.png\" alt=\"\"/></a></li>");
                }
                else
                {
            ...
            {
                newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=" + (Pageindex - 1) + "\"><img src=\"img/News_tap/page_pre.png\" alt=\"\"/></a></li>");

                if (Pageindex + 1 <= pageCount)
                {
                    newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=").Append(Pageindex - 1).Append("\" >").Append(Pageindex - 1).Append("</a></li>");
                    newsStr.Append("<li class=\"on\"><a href=\"New_hy.aspx?pageindex=").Append(Pageindex).Append("\" >").Append(Pageindex).Append("</a></li>");
                    newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=").Append(Pageindex + 1).Append("\" >").Append(Pageindex + 1).Append("</a></li>");
                    newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=" + (Pageindex + 1) + "\"><img src=\"img/News_tap/page_next.png\" alt=\"\"/></a></li>");
                }
                ...
                {
                    newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=").Append(Pageindex - 2).Append("\" >").Append(Pageindex - 2).Append("</a></li>");
                    newsStr.Append("<li><a href=\"New_hy.aspx?pageindex=").Append(Pageindex - 1).Append("\" >").Append(Pageindex - 1).Append("</a></li>");
                    newsStr.Append("<li class=\"on\"><a href=\"New_hy.aspx?pageindex=").Append(Pageindex).Append("\" >").Append(Pageindex).Append("</a></li>");
                    newsStr.Append("<li><img src=\"img/News_tap/page_next.png\" alt=\"\"/></li>");
                }
