...
//导航栏隐藏部分
    $(document).ready(function() {
        $(".menu_li2").hover(function(){
            $(".dropdown-menu_li1").show();
        },function(){
            $(".dropdown-menu_li1").hide();
        });
    });
...
//电话咨询弹窗
    function alertTip() {
        ...
        $("#sxhj").append("" +
            ...
            "<img id='sxhjimg' src=\"../validates.ashx?f=sxhj\"" +
            " style=\"border-radius: 2px;border: 1px solid #898989;\" width=\"120\"" +
            " onclick=\"javascript:var rn=Math.random();this.src='../validates.ashx?f=sxhj&ra='+rn;\" height=\"42\"/>" +
            "</a>");
        $(".modal-backdrop").css("display", "block");
        $("#Dialog-con").show();
        $(".modal-back").show();
...
//tab栏切换
    $(".verticalNav>li").bind("click",function(){
       var index=$(this).index();
        $(this).addClass("NavActive").find("a").addClass("aActive").
        parent().siblings("li").removeClass("NavActive").find("a").removeClass("aActive")
    });
